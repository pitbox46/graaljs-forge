 ...
 *
 * The starting point is {@link Source#newBuilder(String, File)} method.
 *
 * <h3>Read from an URL</h3>
 *
 * One can read remote or in JAR resources using the {@link Source#newBuilder(String, URL)}
 * factory: <br>
 *
 ...
 * {@link Source#newBuilder(String, Reader, String)} method: <br>
 *
...
public final class Source {
     ...
     * {@link Source#newBuilder(String, File) file on a disk} changes and is re-loaded.
     *
