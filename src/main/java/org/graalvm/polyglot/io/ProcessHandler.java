...
public interface ProcessHandler {
     ...
     * {@link #start(ProcessCommand) start} method.
     *
     * @since 19.1.0
     */
    ...
    final class Redirect {
        ...
        enum Type {
            ...
            INHERIT,
            /**
             * The type of {@link Redirect#stream(OutputStream) Redirect.stream}.
             */
            STREAM
        }
    }
...
final class ProcessHandlerSnippets implements ProcessHandler {
    ...
    private static ProcessBuilder.Redirect asProcessBuilderRedirect(Redirect redirect) {
