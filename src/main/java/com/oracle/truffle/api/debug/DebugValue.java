...
public abstract class DebugValue {
        ...
        if (value != null) {
            try {
                if (!INTEROP.isMemberExisting(value, name)) {
                    ...
                    return new ObjectMemberValue(getSession(), resolveLanguage(), null, value, name);
                }
            } catch (ThreadDeath td) {
                throw td;
            } catch (Throwable ex) {
    ...
    public DebugValue getIterator() throws DebugException {
        ...
        return new HeapValue(getSession(), preferredLanguage, null, iterator);
    }
    ...
    public DebugValue getIteratorNextElement() throws NoSuchElementException, DebugException {
        ...
        return new HeapValue(getSession(), preferredLanguage, null, next);
    }
    ...
    public DebugValue getHashKeysIterator() throws DebugException {
        ...
        return new HeapValue(getSession(), preferredLanguage, null, keysIterator);
    }
    ...
    public DebugValue getHashValuesIterator() throws DebugException {
        ...
        return new HeapValue(getSession(), preferredLanguage, null, valuesIterator);
    }
