...
public abstract class Shape {
     ...
     * {@link Builder#shapeFlags(int)}. If no shape flags were explicitly set, the default of
     * 0 is returned.
     *
     ...
     * @see Builder#dynamicType(Object)
     * @since 20.2.0
     */
     ...
     * @see Builder#propertyAssumptions(boolean)
     * @since 20.2.0
     */
