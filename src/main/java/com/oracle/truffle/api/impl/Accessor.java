...
public abstract class Accessor {
    ...
    public abstract static class LanguageSupport extends Support {
        ...
        public abstract Object findExportedSymbol(Env env, String globalName, boolean onlyExplicit);

        public abstract void dispose(Env env);

        public abstract LanguageInfo getLanguageInfo(Env env);
        ...
        public abstract Object getLegacyScopedView(Env env, Node node, Frame frame, Object value);

        public abstract Object getLanguageView(Env env, Object value);
    ...
    public abstract static class InstrumentSupport extends Support {
        ...
        public abstract org.graalvm.polyglot.SourceSection createSourceSection(Object instrumentEnv, org.graalvm.polyglot.Source source, SourceSection ss);
...
// before ...Accessor classes static initializers run, which call methods from Accessor.
    private static class Constants {
        ...
        private static final LanguageSupport LANGUAGE;
        private static final NodeSupport NODES;
        private static final InstrumentSupport INSTRUMENT;
        private static final SourceSupport SOURCE;
        private static final InteropSupport INTEROP;
        private static final ExceptionSupport EXCEPTION;
        private static final IOSupport IO;
        private static final FrameSupport FRAMES;
        private static final EngineSupport ENGINE;
        private static final HostSupport HOST;
        private static final RuntimeSupport RUNTIME;
