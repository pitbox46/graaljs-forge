 ...
 * be obtained from {@link Env#lookup(Class) Env.lookup(AllocationReporter.class)}. If
...
public final class AllocationReporter {
     ...
     * called. Methods {@link #onEnter(Object, long, long)} and
     * {@link #onReturnValue(Object, long, long)} have no effect when this method returns
     ...
     * {@link AllocationListener#onEnter(AllocationEvent)}.
     ...
     * {@link #onReturnValue(Object, long, long)} with the actual allocated value, or with
     ...
     * {@link AllocationListener#onReturnValue(AllocationEvent)}
     * . Only primitive types, String and {@link com.oracle.truffle.api.interop.TruffleObject} are
     ...
     * <p>
     * A call to {@link #onEnter(Object, long, long)} must precede this call. In case of
     * re-allocation, the value object passed to {@link #onEnter(Object, long, long)} must
