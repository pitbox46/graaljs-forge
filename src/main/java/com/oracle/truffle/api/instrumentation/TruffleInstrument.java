 ...
 * {@link Env#getOptions() option} was specified or if a
 * {@link Env#registerService(Object) service} was looked up. The
...
public abstract class TruffleInstrument {
     ...
     * <p>
     * The method may {@link Env#registerService(Object) register} additional
     ...
     * implement it, instantiate and {@link Env#registerService(Object) register} in own's
     * instrument {@link #onCreate(Env)
     * onCreate} method:
     *
     ...
     * {@linkplain Engine engine} is going to be closed. This method is called
     ...
     * because the underlying {@linkplain Engine engine} has been closed. A
    ...
    public static final class Env {
        ...
        /**
         * Input associated with {@link Engine} this {@link TruffleInstrument
        ...
        /**
         * Standard output writer for {@link Engine} this
        ...
        /**
         * Standard error writer for {@link Engine} this
         * {@link TruffleInstrument instrument} is being executed in.
         *
         * @return writer, never <code>null</code>
         * @since 0.12
         ...
         * <p>
         * When {@link MessageTransport.VetoException} is thrown, the server
         ...
         * {@link InteropLibrary#getLanguage(Object) language}.
         * <li>Provide a language specific
         * {@link InteropLibrary#toDisplayString(Object) display
         * string} for primitive and foreign values.
         * <li>Return a language specific
         * {@link InteropLibrary#getMetaObject(Object) metaobject}
         ...
         * returned. For the best results, use the {@link #findLanguage(Object) value's
         * language}, if any.
         *
         * @param language a language
         ...
         * For the best results, use the {@link #findLanguage(Object) value's language},
         * if any.
         *
         * @param language a language
         ...
         * {@link #findTopScopes(String)}. The iteration order corresponds with the scope
         ...
         *         outer-most.
         * @see TruffleLanguage#findLocalScopes(Object, Node,
         *      Frame)
         * @since 0.30
         ...
         *         language
         * @see TruffleLanguage#findTopScopes(Object)
         * @since 0.30
         ...
         * {@link InteropLibrary#isScope(Object) interop scope
         ...
         * <p>
         * Unlike loggers created by
         * {@link TruffleLogger#getLogger(String, Class)
         * TruffleLogger.getLogger} loggers created by this method are bound to engine, there may be
         * more logger instances having the same name but each bound to different engine instance.
         * Instruments should never store the returned logger into a static fields. A new logger
         * must be always created in
    ...
    public @interface Registration {
         ...
         * {@link #onCreate(Env) onCreate}
         * method and instantiate and {@link Env#registerService(Object) register} all
         * here in defined services.
         * <p>
         * Instruments automatically get created when their registered
         * {@link org.graalvm.polyglot.Instrument#lookup(Class) service is requested}.
         *
         * @since 0.25
