...
public final class StandardTags {
     ...
     * desired behavior.</li>
     * </ul>
     * The StatemenTag uses the {@link Identifier identifier} <code>"STATEMENT"</code>. A node
     ...
     * </ul>
     *
     * The CallTag uses the {@link Identifier identifier} <code>"CALL"</code>. A node tagged
     ...
     * </ul>
     *
     * The RootTag uses the {@link Identifier identifier} <code>"ROOT"</code>. A node tagged
     ...
     * </ul>
     *
     * The RootBodyTag uses the {@link Identifier identifier} <code>"ROOT_BODY"</code>. A node
     ...
     * </ul>
     *
     * The ExpressionTag uses the {@link Identifier identifier} <code>"EXPRESSION"</code>. A
