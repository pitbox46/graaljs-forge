 ...
 * location where {@linkplain TruffleInstrument Truffle
 ...
 * {@link TruffleInstrument instrument} might require a guest
 ...
 *
 * {@link InstrumentableNodeSnippets.SimpleNode}
 *
 * <p>
 * Example for a typical implementation of an instrumentable node with support for source
 * sections:</b>
 * {@link InstrumentableNodeSnippets.RecommendedNode}
 * <p>
 *
...
public interface InstrumentableNode extends NodeInterface {
     ...
     * location:
     * <ul>
     * <li>{@linkplain ProbeNode#onEnter(VirtualFrame) onEnter(Frame)}:
     * an <em>execute</em> method on the delegate is ready to be called;</li>
     * <li>{@linkplain ProbeNode#onReturnValue(VirtualFrame, Object)
     ...
     *
     * {@link InstrumentableNodeSnippets.StatementNode}
     *
     * <p>
     ...
     *
     * {@link InstrumentableNodeSnippets.HaltNode}
     *
     * <p>
     ...
     * threaded. The method may be invoked without a language context currently being active.
     *
     * @param tag the class {@link ProvidedTags provided} by
     ...
     * of the AST:
     * <p>
     * {@link InstrumentableNodeSnippets.ExpressionNode}
     *
