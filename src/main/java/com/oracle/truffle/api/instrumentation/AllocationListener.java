 ...
 * <p>
 * Use
 * {@link Instrumenter#attachAllocationListener(AllocationEventFilter, AllocationListener)}
 * to register an implementation of this listener. Use {@link EventBinding#dispose()} to unregister.
 * <p>
 * The listener gets called {@link #onEnter(AllocationEvent)
 * before} the actual allocation and right
 * {@link #onReturnValue(AllocationEvent) after} it. The
 ...
 *
 * @since 0.27
 * @see Instrumenter#attachAllocationListener(AllocationEventFilter,
 *      AllocationListener)
...
public interface AllocationListener {
     ...
     * {@link #onReturnValue(AllocationEvent)} after the
     ...
     * {@link #onEnter(AllocationEvent)} call and right after
     * the allocation is performed. When
     * {@link #onEnter(AllocationEvent) onEnter} provided a
