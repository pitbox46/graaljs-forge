 ...
 * <ul>
 * <li>{@link StaticShape#newBuilder(TruffleLanguage)} returns a {@link Builder} object
 * that can be used to {@linkplain Builder#property(StaticProperty, Class, boolean)
 ...
 * default} or the {@linkplain Builder#build(Class, Class) user-defined} factory
 ...
 * its {@linkplain Builder#build(StaticShape) parent shapes}. Note that static shapes do
 ...
 *            {@linkplain Builder#build(Class, Class) user-defined} factory interface to
...
public abstract class StaticShape<T> {
     ...
     * using {@link Builder#property(StaticProperty, Class, boolean)}. Then, after
     * allocating a {@link StaticShape} instance with one of the {@link Builder#build()}
     ...
     * {@linkplain Builder#build(Class, Class) user-defined} factory interface that must
     * be used to allocate static objects with the current shape.
     *
     * @see Builder#build()
     * @see Builder#build(StaticShape)
     * @see Builder#build(Class, Class)
     * @since 21.3.0
     */
    ...
    public static final class Builder {
         ...
         * {@linkplain Builder#build(StaticShape) extend a parent shape} can have
