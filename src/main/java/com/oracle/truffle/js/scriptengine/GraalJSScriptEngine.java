...
public final class GraalJSScriptEngine extends AbstractScriptEngine implements Compilable, Invocable, AutoCloseable {
    ...
    interface MagicBindingsOptionSetter {
        ...
        Builder setOption(Builder builder, Object value);
    }
    ...
    private final Builder contextConfig;
    ...
    GraalJSScriptEngine(GraalJSEngineFactory factory, Engine engine, Builder contextConfig) {
        Engine engineToUse = engine;
        if (engineToUse == null) {
            engineToUse = Engine.newBuilder().allowExperimentalOptions(true).build();
        }
        Builder contextConfigToUse = contextConfig;
    ...
    private static void updateForNashornCompatibilityMode(Builder builder) {
        builder.allowAllAccess(true);
        builder.allowHostAccess(NASHORN_HOST_ACCESS);
    }

    private static void updateForScriptEngineAccessibility(Builder builder) {
        builder.allowHostAccess(HostAccess.ALL);
    }

    static Context createDefaultContext(Builder builder) {
     ...
     *
     * @see #create(Engine, Builder) to customize the configuration.
     */
     ...
     *            context instances.
     */
    public static GraalJSScriptEngine create(Engine engine, Builder newContextConfig) {
