...
public final class RestObjectNodeGen extends RestObjectNode implements Introspection.Provider {
    ...
    public Object execute(VirtualFrame frameValue) {
        ...
        if (state_0 != 0 /* is-state_0 doNullOrUndefined(DynamicObject, Object) || copyDataProperties(DynamicObject, DynamicObject) || doOther(DynamicObject, Object, JSToObjectNode) */ && JSTypes.isDynamicObject(targetNodeValue_)) {
            DynamicObject targetNodeValue__ = (DynamicObject) targetNodeValue_;
            if ((state_0 & 0b1) != 0 /* is-state_0 doNullOrUndefined(DynamicObject, Object) */) {
                if ((JSGuards.isNullOrUndefined(sourceNodeValue_))) {
                    return RestObjectNode.doNullOrUndefined(targetNodeValue__, sourceNodeValue_);
                }
            }
            if ((state_0 & 0b10) != 0 /* is-state_0 copyDataProperties(DynamicObject, DynamicObject) */ && JSTypes.isDynamicObject(sourceNodeValue_)) {
            ...
            if ((state_0 & 0b100) != 0 /* is-state_0 doOther(DynamicObject, Object, JSToObjectNode) */) {
        ...
        try {
            ...
            if (JSTypes.isDynamicObject(targetNodeValue)) {
                ...
                if ((JSGuards.isNullOrUndefined(sourceNodeValue))) {
                    this.state_0_ = state_0 = state_0 | 0b1 /* add-state_0 doNullOrUndefined(DynamicObject, Object) */;
                    lock.unlock();
                    hasLock = false;
                ...
                if (JSTypes.isDynamicObject(sourceNodeValue)) {
                    ...
                    if ((JSGuards.isJSObject(sourceNodeValue_))) {
                        this.state_0_ = state_0 = state_0 | 0b10 /* add-state_0 copyDataProperties(DynamicObject, DynamicObject) */;
                        lock.unlock();
                        hasLock = false;
                ...
                if ((!(JSGuards.isJSDynamicObject(sourceNodeValue)))) {
                    ...
                    this.state_0_ = state_0 = state_0 | 0b100 /* add-state_0 doOther(DynamicObject, Object, JSToObjectNode) */;
                    lock.unlock();
                    hasLock = false;
    ...
    public Introspection getIntrospectionData() {
        ...
        if ((state_0 & 0b10) != 0 /* is-state_0 copyDataProperties(DynamicObject, DynamicObject) */) {
            s[1] = (byte)0b01 /* active */;
        } else {
            s[1] = (byte)0b00 /* inactive */;
        }
