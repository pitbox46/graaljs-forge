...
public final class JSRightShiftConstantNodeGen extends JSRightShiftConstantNode implements Introspection.Provider {
    ...
    public Object execute(VirtualFrame frameValue, Object operandNodeValue) {
        ...
        if ((state_0 & 0b100000) != 0 /* is-state_0 doGeneric(Object, JSToNumericNode, JSRightShiftConstantNode) */) {
    ...
    public Object execute(VirtualFrame frameValue) {
        int state_0 = this.state_0_;
        if ((state_0 & 0b110110) == 0 /* only-active doInteger(int) */ && ((state_0 & 0b110111) != 0  /* is-not doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) && doOverloaded(JSOverloadedOperatorsObject, JSOverloadedBinaryNode) && doGeneric(Object, JSToNumericNode, JSRightShiftConstantNode) */)) {
            return execute_int0(state_0, frameValue);
        } else if ((state_0 & 0b110011) == 0 /* only-active doDouble(double, JSToInt32Node) */ && ((state_0 & 0b110111) != 0  /* is-not doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) && doOverloaded(JSOverloadedOperatorsObject, JSOverloadedBinaryNode) && doGeneric(Object, JSToNumericNode, JSRightShiftConstantNode) */)) {
    ...
    private Object execute_double1(int state_0, VirtualFrame frameValue) {
        ...
        try {
            if ((state_0 & 0b1110000000) == 0 /* only-active 0:double */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) && doBigInt(BigInt) && doOverloaded(JSOverloadedOperatorsObject, JSOverloadedBinaryNode) && doGeneric(Object, JSToNumericNode, JSRightShiftConstantNode) */)) {
            ...
            } else if ((state_0 & 0b1101000000) == 0 /* only-active 0:double */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) && doBigInt(BigInt) && doOverloaded(JSOverloadedOperatorsObject, JSOverloadedBinaryNode) && doGeneric(Object, JSToNumericNode, JSRightShiftConstantNode) */)) {
                operandNodeValue_int = super.operandNode.executeInt(frameValue);
                operandNodeValue_ = JSTypes.intToDouble(operandNodeValue_int);
            } else if ((state_0 & 0b1011000000) == 0 /* only-active 0:double */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) && doBigInt(BigInt) && doOverloaded(JSOverloadedOperatorsObject, JSOverloadedBinaryNode) && doGeneric(Object, JSToNumericNode, JSRightShiftConstantNode) */)) {
    ...
    public int executeInt(VirtualFrame frameValue) throws UnexpectedResultException {
        ...
        if ((state_0 & 0b100110) == 0 /* only-active doInteger(int) */ && ((state_0 & 0b100111) != 0  /* is-not doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) && doGeneric(Object, JSToNumericNode, JSRightShiftConstantNode) */)) {
            return executeInt_int3(state_0, frameValue);
        } else if ((state_0 & 0b100011) == 0 /* only-active doDouble(double, JSToInt32Node) */ && ((state_0 & 0b100111) != 0  /* is-not doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) && doGeneric(Object, JSToNumericNode, JSRightShiftConstantNode) */)) {
    ...
    public void executeVoid(VirtualFrame frameValue) {
        int state_0 = this.state_0_;
        try {
            if ((state_0 & 0b11000) == 0 /* only-active doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) && doGeneric(Object, JSToNumericNode, JSRightShiftConstantNode) */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) && doBigInt(BigInt) && doOverloaded(JSOverloadedOperatorsObject, JSOverloadedBinaryNode) && doGeneric(Object, JSToNumericNode, JSRightShiftConstantNode) */)) {
                executeInt(frameValue);
                return;
            } else if ((state_0 & 0b110111) != 0 /* is-state_0 doInteger(int) || doSafeInteger(SafeInteger) || doDouble(double, JSToInt32Node) || doOverloaded(JSOverloadedOperatorsObject, JSOverloadedBinaryNode) || doGeneric(Object, JSToNumericNode, JSRightShiftConstantNode) */) {
                execute(frameValue);
                return;
            }
        } catch (UnexpectedResultException ex) {
    ...
    private Object executeAndSpecialize(Object operandNodeValue) {
        ...
        try {
            ...
            if ((!(JSGuards.hasOverloadedOperators(operandNodeValue)))) {
                ...
                this.state_0_ = state_0 = state_0 | 0b100000 /* add-state_0 doGeneric(Object, JSToNumericNode, JSRightShiftConstantNode) */;
                lock.unlock();
                hasLock = false;
                return doGeneric(operandNodeValue, this.generic_leftToNumeric_, this.generic_innerShiftNode_);
            }
