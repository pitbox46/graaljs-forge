...
public final class PrivateFieldSetNodeGen extends PrivateFieldSetNode implements Introspection.Provider {
    ...
    public Object executeWithTarget(VirtualFrame frameValue, Object targetNodeValue) {
        ...
        if (state_0 != 0 /* is-state_0 doField(DynamicObject, HiddenKey, Object, DynamicObjectLibrary, BranchProfile) || doField(DynamicObject, HiddenKey, Object, DynamicObjectLibrary, BranchProfile) || doAccessor(DynamicObject, Accessor, Object, JSFunctionCallNode, BranchProfile) || missing(Object, Object, Object) */) {
            if ((state_0 & 0b111) != 0 /* is-state_0 doField(DynamicObject, HiddenKey, Object, DynamicObjectLibrary, BranchProfile) || doField(DynamicObject, HiddenKey, Object, DynamicObjectLibrary, BranchProfile) || doAccessor(DynamicObject, Accessor, Object, JSFunctionCallNode, BranchProfile) */ && JSTypes.isDynamicObject(targetNodeValue)) {
                DynamicObject targetNodeValue_ = (DynamicObject) targetNodeValue;
                if ((state_0 & 0b11) != 0 /* is-state_0 doField(DynamicObject, HiddenKey, Object, DynamicObjectLibrary, BranchProfile) || doField(DynamicObject, HiddenKey, Object, DynamicObjectLibrary, BranchProfile) */ && keyNodeValue_ instanceof HiddenKey) {
                    HiddenKey keyNodeValue__ = (HiddenKey) keyNodeValue_;
                    if ((state_0 & 0b1) != 0 /* is-state_0 doField(DynamicObject, HiddenKey, Object, DynamicObjectLibrary, BranchProfile) */) {
                        Field0Data s0_ = this.field0_cache;
                        while (s0_ != null) {
                            if ((s0_.access_.accepts(targetNodeValue_)) && (JSGuards.isJSObject(targetNodeValue_))) {
                                return doField(targetNodeValue_, keyNodeValue__, valueNodeValue_, s0_.access_, s0_.errorBranch_);
                            }
                            s0_ = s0_.next_;
                        }
                    }
                    if ((state_0 & 0b10) != 0 /* is-state_0 doField(DynamicObject, HiddenKey, Object, DynamicObjectLibrary, BranchProfile) */) {
                ...
                if ((state_0 & 0b100) != 0 /* is-state_0 doAccessor(DynamicObject, Accessor, Object, JSFunctionCallNode, BranchProfile) */ && keyNodeValue_ instanceof Accessor) {
            ...
            if ((state_0 & 0b1000) != 0 /* is-state_0 missing(Object, Object, Object) */) {
    ...
    @TruffleBoundary
    private Object field1Boundary(int state_0, DynamicObject targetNodeValue_, HiddenKey keyNodeValue__, Object valueNodeValue_) {
        {
    ...
    public Object execute(VirtualFrame frameValue) {
        ...
        Object valueNodeValue_ = super.valueNode.execute(frameValue);
        if (state_0 != 0 /* is-state_0 doField(DynamicObject, HiddenKey, Object, DynamicObjectLibrary, BranchProfile) || doField(DynamicObject, HiddenKey, Object, DynamicObjectLibrary, BranchProfile) || doAccessor(DynamicObject, Accessor, Object, JSFunctionCallNode, BranchProfile) || missing(Object, Object, Object) */) {
            if ((state_0 & 0b111) != 0 /* is-state_0 doField(DynamicObject, HiddenKey, Object, DynamicObjectLibrary, BranchProfile) || doField(DynamicObject, HiddenKey, Object, DynamicObjectLibrary, BranchProfile) || doAccessor(DynamicObject, Accessor, Object, JSFunctionCallNode, BranchProfile) */ && JSTypes.isDynamicObject(targetNodeValue_)) {
                    ...
                    if ((state_0 & 0b1) != 0 /* is-state_0 doField(DynamicObject, HiddenKey, Object, DynamicObjectLibrary, BranchProfile) */) {
                        ...
                        while (s0_ != null) {
                            if ((s0_.access_.accepts(targetNodeValue__)) && (JSGuards.isJSObject(targetNodeValue__))) {
                                return doField(targetNodeValue__, keyNodeValue__, valueNodeValue_, s0_.access_, s0_.errorBranch_);
                            }
                            s0_ = s0_.next_;
                        }
                    }
    ...
    @SuppressWarnings("static-method")
    @TruffleBoundary
    private Object field1Boundary0(int state_0, DynamicObject targetNodeValue__, HiddenKey keyNodeValue__, Object valueNodeValue_) {
        {
        ...
        try {
            ...
            if (JSTypes.isDynamicObject(targetNodeValue)) {
                ...
                if (keyNodeValue instanceof HiddenKey) {
                    ...
                    if ((exclude) == 0 /* is-not-exclude doField(DynamicObject, HiddenKey, Object, DynamicObjectLibrary, BranchProfile) */) {
                        int count0_ = 0;
                        Field0Data s0_ = this.field0_cache;
                        if ((state_0 & 0b1) != 0 /* is-state_0 doField(DynamicObject, HiddenKey, Object, DynamicObjectLibrary, BranchProfile) */) {
                            while (s0_ != null) {
                        ...
                        if (s0_ == null) {
                            if ((JSGuards.isJSObject(targetNodeValue_)) && count0_ < (3)) {
                                ...
                                this.state_0_ = state_0 = state_0 | 0b1 /* add-state_0 doField(DynamicObject, HiddenKey, Object, DynamicObjectLibrary, BranchProfile) */;
                            }
                        }
                        if (s0_ != null) {
                            lock.unlock();
                            hasLock = false;
                            return doField(targetNodeValue_, keyNodeValue_, valueNodeValue, s0_.access_, s0_.errorBranch_);
                        }
                    }
                    {
                        ...
                        if ((JSGuards.isJSObject(targetNodeValue_))) {
                            ...
                            this.exclude_ = exclude = exclude | 0b1 /* add-exclude doField(DynamicObject, HiddenKey, Object, DynamicObjectLibrary, BranchProfile) */;
                            this.field0_cache = null;
                            state_0 = state_0 & 0xfffffffe /* remove-state_0 doField(DynamicObject, HiddenKey, Object, DynamicObjectLibrary, BranchProfile) */;
                            this.state_0_ = state_0 = state_0 | 0b10 /* add-state_0 doField(DynamicObject, HiddenKey, Object, DynamicObjectLibrary, BranchProfile) */;
                            lock.unlock();
                            hasLock = false;
                ...
                if (keyNodeValue instanceof Accessor) {
                    ...
                    if ((JSGuards.isJSObject(targetNodeValue_))) {
                        ...
                        this.state_0_ = state_0 = state_0 | 0b100 /* add-state_0 doAccessor(DynamicObject, Accessor, Object, JSFunctionCallNode, BranchProfile) */;
                        lock.unlock();
                        hasLock = false;
            ...
            this.state_0_ = state_0 = state_0 | 0b1000 /* add-state_0 missing(Object, Object, Object) */;
            lock.unlock();
            hasLock = false;
    ...
    public Introspection getIntrospectionData() {
        ...
        if ((state_0 & 0b1) != 0 /* is-state_0 doField(DynamicObject, HiddenKey, Object, DynamicObjectLibrary, BranchProfile) */) {
            ...
            s[2] = cached;
        } else if (exclude != 0 /* is-exclude doField(DynamicObject, HiddenKey, Object, DynamicObjectLibrary, BranchProfile) */) {
        ...
        s = new Object[3];
        s[0] = "doAccessor";
        if ((state_0 & 0b100) != 0 /* is-state_0 doAccessor(DynamicObject, Accessor, Object, JSFunctionCallNode, BranchProfile) */) {
            s[1] = (byte)0b01 /* active */;
            ArrayList<Object> cached = new ArrayList<>();
