...
public final class JSToDoubleNodeGen extends JSToDoubleNode implements Introspection.Provider {
    ...
    public Object execute(Object arg0Value) {
        ...
        if ((state_0 & 0b1000) != 0 /* is-state_0 doBigInt(BigInt) */ && arg0Value instanceof BigInt) {
            BigInt arg0Value_ = (BigInt) arg0Value;
            return doBigInt(arg0Value_);
        }
        if ((state_0 & 0b110000) != 0 /* is-state_0 doNull(Object) || doUndefined(Object) */) {
            if ((state_0 & 0b10000) != 0 /* is-state_0 doNull(Object) */) {
        ...
        if ((state_0 & 0b1000000) != 0 /* is-state_0 doStringDouble(String, JSStringToNumberNode) */ && JSTypesGen.isImplicitString((state_0 & 0x38000) >>> 15 /* extract-implicit-state_0 0:String */, arg0Value)) {
        ...
        if ((state_0 & 0b10000000) != 0 /* is-state_0 doJSObject(DynamicObject, JSToPrimitiveNode) */ && JSTypes.isDynamicObject(arg0Value)) {
        ...
        if ((state_0 & 0b11000000000) != 0 /* is-state_0 doForeignObject(Object, JSToPrimitiveNode) || doJavaNumber(Object) */) {
            ...
            if ((state_0 & 0b10000000000) != 0 /* is-state_0 doJavaNumber(Object) */) {
    ...
    private double executeAndSpecialize(Object arg0Value) {
        ...
        try {
            ...
            if ((JSGuards.isJSNull(arg0Value))) {
                this.state_0_ = state_0 = state_0 | 0b10000 /* add-state_0 doNull(Object) */;
                lock.unlock();
                hasLock = false;
                return JSToDoubleNode.doNull(arg0Value);
            }
            ...
            }
            {
                ...
                if ((stringCast0 = JSTypesGen.specializeImplicitString(arg0Value)) != 0) {
                    ...
                    this.state_0_ = state_0 = state_0 | 0b1000000 /* add-state_0 doStringDouble(String, JSStringToNumberNode) */;
                    lock.unlock();
                    hasLock = false;
                    return JSToDoubleNode.doStringDouble(arg0Value_, this.stringDouble_stringToNumberNode_);
                }
            ...
            if (JSTypes.isDynamicObject(arg0Value)) {
                ...
                if ((JSGuards.isJSObject(arg0Value_))) {
                    ...
                    this.state_0_ = state_0 = state_0 | 0b10000000 /* add-state_0 doJSObject(DynamicObject, JSToPrimitiveNode) */;
                    lock.unlock();
                    hasLock = false;
                    return doJSObject(arg0Value_, this.jSObject_toPrimitiveNode_);
                }
            ...
            if ((JSGuards.isJavaNumber(arg0Value))) {
                this.state_0_ = state_0 = state_0 | 0b10000000000 /* add-state_0 doJavaNumber(Object) */;
                lock.unlock();
                hasLock = false;
                return JSToDoubleNode.doJavaNumber(arg0Value);
            }
    ...
    public Introspection getIntrospectionData() {
        ...
        s = new Object[3];
        s[0] = "doStringDouble";
        if ((state_0 & 0b1000000) != 0 /* is-state_0 doStringDouble(String, JSStringToNumberNode) */) {
            s[1] = (byte)0b01 /* active */;
        ...
        s = new Object[3];
        s[0] = "doJSObject";
        if ((state_0 & 0b10000000) != 0 /* is-state_0 doJSObject(DynamicObject, JSToPrimitiveNode) */) {
            s[1] = (byte)0b01 /* active */;
            ArrayList<Object> cached = new ArrayList<>();
