...
public final class JSAddConstantLeftNumberNodeGen extends JSAddConstantLeftNumberNode implements Introspection.Provider {
    ...
    public Object execute(Object operandNodeValue) {
        ...
        if ((state_0 & 0b100000) != 0 /* is-state_0 doNumberString(CharSequence, String, JSConcatStringsNode) */ && JSTypesGen.isImplicitCharSequence((state_0 & 0b111000000000000) >>> 12 /* extract-implicit-state_0 0:CharSequence */, operandNodeValue)) {
    ...
    public Object execute(VirtualFrame frameValue) {
        int state_0 = this.state_0_;
        if ((state_0 & 0b11111000) == 0 /* only-active doIntTruncate(int) && doInt(int) && doIntOverflow(int) */ && ((state_0 & 0b11111111) != 0  /* is-not doIntTruncate(int) && doInt(int) && doIntOverflow(int) && doSafeInteger(SafeInteger) && doDouble(double) && doNumberString(CharSequence, String, JSConcatStringsNode) && doOverloaded(JSOverloadedOperatorsObject, JSOverloadedBinaryNode) && doPrimitiveConversion(Object, JSToPrimitiveNode, JSToNumberNode, String, JSConcatStringsNode, ConditionProfile) */)) {
    ...
    private Object execute_generic2(int state_0, VirtualFrame frameValue) {
        ...
        if ((state_0 & 0b100000) != 0 /* is-state_0 doNumberString(CharSequence, String, JSConcatStringsNode) */ && JSTypesGen.isImplicitCharSequence((state_0 & 0b111000000000000) >>> 12 /* extract-implicit-state_0 0:CharSequence */, operandNodeValue_)) {
    ...
    private Object executeAndSpecialize(Object operandNodeValue) {
        ...
        try {
            ...
            if (((exclude & 0b10000)) == 0 /* is-not-exclude doNumberString(CharSequence, String, JSConcatStringsNode) */) {
                ...
                if ((charSequenceCast0 = JSTypesGen.specializeImplicitCharSequence(operandNodeValue)) != 0) {
                    ...
                    this.state_0_ = state_0 = state_0 | 0b100000 /* add-state_0 doNumberString(CharSequence, String, JSConcatStringsNode) */;
                    lock.unlock();
                    hasLock = false;
                    return doNumberString(operandNodeValue_, this.numberString_leftString_, this.numberString_createLazyString_);
                }
            ...
            if ((!(JSGuards.hasOverloadedOperators(operandNodeValue)))) {
                ...
                this.exclude_ = exclude = exclude | 0b11001 /* add-exclude doInt(int), doDouble(double), doNumberString(CharSequence, String, JSConcatStringsNode) */;
                state_0 = state_0 & 0xffffffcd /* remove-state_0 doInt(int), doDouble(double), doNumberString(CharSequence, String, JSConcatStringsNode) */;
    ...
    public Introspection getIntrospectionData() {
        ...
        s = new Object[3];
        s[0] = "doNumberString";
        if ((state_0 & 0b100000) != 0 /* is-state_0 doNumberString(CharSequence, String, JSConcatStringsNode) */) {
            s[1] = (byte)0b01 /* active */;
            ArrayList<Object> cached = new ArrayList<>();
            cached.add(Arrays.asList(this.numberString_leftString_, this.numberString_createLazyString_));
            s[2] = cached;
        } else if ((exclude & 0b10000) != 0 /* is-exclude doNumberString(CharSequence, String, JSConcatStringsNode) */) {
            s[1] = (byte)0b10 /* excluded */;
        } else {
            s[1] = (byte)0b00 /* inactive */;
        }
