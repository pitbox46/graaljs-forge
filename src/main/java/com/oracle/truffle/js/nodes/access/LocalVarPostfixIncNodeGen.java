...
final class LocalVarPostfixIncNodeGen extends LocalVarPostfixIncNode implements Introspection.Provider {
    ...
    private LocalVarPostfixIncNodeGen(LocalVarOp op, FrameSlot frameSlot, boolean hasTemporalDeadZone, ScopeFrameNode scopeFrameNode, FrameDescriptor frameDescriptor) {
    ...
    public Object execute(VirtualFrame frameValue) {
        ...
        if (state_0 != 0 /* is-state_0 doBoolean(Frame) || doBooleanDouble(Frame) || doBooleanObject(Frame) || doInt(Frame) || doIntDouble(Frame) || doIntObject(Frame) || doDouble(Frame) || doDoubleObject(Frame) || doObject(Frame, ConditionProfile, ConditionProfile, ConditionProfile, ConditionProfile, JSOverloadedUnaryNode, JSToNumericNode, BranchProfile) || doSafeInteger(Frame) || doSafeIntegerToDouble(Frame) || doSafeIntegerObject(Frame) */) {
            ...
            if ((state_0 & 0b100000000000) != 0 /* is-state_0 doSafeIntegerObject(Frame) */) {
    ...
    public double executeDouble(VirtualFrame frameValue) throws UnexpectedResultException {
        ...
        Frame scopeFrameNodeValue_ = super.scopeFrameNode.executeFrame(frameValue);
        if ((state_0 & 0b110011000000) != 0 /* is-state_0 doDouble(Frame) || doDoubleObject(Frame) || doSafeIntegerToDouble(Frame) || doSafeIntegerObject(Frame) */) {
            if ((state_0 & 0b1000000) != 0 /* is-state_0 doDouble(Frame) */) {
                if ((isDouble(scopeFrameNodeValue_)) && (isDoubleKind(scopeFrameNodeValue_))) {
                    return doDouble(scopeFrameNodeValue_);
                }
    ...
    public int executeInt(VirtualFrame frameValue) throws UnexpectedResultException {
        ...
        Frame scopeFrameNodeValue_ = super.scopeFrameNode.executeFrame(frameValue);
        if ((state_0 & 0b111111) != 0 /* is-state_0 doBoolean(Frame) || doBooleanDouble(Frame) || doBooleanObject(Frame) || doInt(Frame) || doIntDouble(Frame) || doIntObject(Frame) */) {
            if ((state_0 & 0b1) != 0 /* is-state_0 doBoolean(Frame) */) {
                if ((isBoolean(scopeFrameNodeValue_)) && (isIntegerKind(scopeFrameNodeValue_))) {
                    return doBoolean(scopeFrameNodeValue_);
                }
    ...
    public void executeVoid(VirtualFrame frameValue) {
        int state_0 = this.state_0_;
        try {
            if ((state_0 & 0b111111000000) == 0 /* only-active doBoolean(Frame) && doBooleanDouble(Frame) && doBooleanObject(Frame) && doInt(Frame) && doIntDouble(Frame) && doIntObject(Frame) */ && (state_0 != 0  /* is-not doBoolean(Frame) && doBooleanDouble(Frame) && doBooleanObject(Frame) && doInt(Frame) && doIntDouble(Frame) && doIntObject(Frame) && doDouble(Frame) && doDoubleObject(Frame) && doObject(Frame, ConditionProfile, ConditionProfile, ConditionProfile, ConditionProfile, JSOverloadedUnaryNode, JSToNumericNode, BranchProfile) && doSafeInteger(Frame) && doSafeIntegerToDouble(Frame) && doSafeIntegerObject(Frame) */)) {
                executeInt(frameValue);
                return;
            } else if ((state_0 & 0b1100111111) == 0 /* only-active doDouble(Frame) && doDoubleObject(Frame) && doSafeIntegerToDouble(Frame) && doSafeIntegerObject(Frame) */ && (state_0 != 0  /* is-not doBoolean(Frame) && doBooleanDouble(Frame) && doBooleanObject(Frame) && doInt(Frame) && doIntDouble(Frame) && doIntObject(Frame) && doDouble(Frame) && doDoubleObject(Frame) && doObject(Frame, ConditionProfile, ConditionProfile, ConditionProfile, ConditionProfile, JSOverloadedUnaryNode, JSToNumericNode, BranchProfile) && doSafeInteger(Frame) && doSafeIntegerToDouble(Frame) && doSafeIntegerObject(Frame) */)) {
    ...
    private Object executeAndSpecialize(Frame scopeFrameNodeValue) {
        ...
        try {
            ...
            if (((exclude & 0b1000)) == 0 /* is-not-exclude doIntDouble(Frame) */) {
                if ((isInt(scopeFrameNodeValue)) && (isDoubleKind(scopeFrameNodeValue))) {
                    ...
                    this.state_0_ = state_0 = state_0 | 0b10000 /* add-state_0 doIntDouble(Frame) */;
                    lock.unlock();
                    hasLock = false;
            ...
            if ((isInt(scopeFrameNodeValue))) {
                this.exclude_ = exclude = exclude | 0b1100 /* add-exclude doInt(Frame), doIntDouble(Frame) */;
                state_0 = state_0 & 0xffffffe7 /* remove-state_0 doInt(Frame), doIntDouble(Frame) */;
                this.state_0_ = state_0 = state_0 | 0b100000 /* add-state_0 doIntObject(Frame) */;
                lock.unlock();
                hasLock = false;
            ...
            if ((isLong(scopeFrameNodeValue))) {
                ...
                this.state_0_ = state_0 = state_0 | 0b100000000000 /* add-state_0 doSafeIntegerObject(Frame) */;
                lock.unlock();
                hasLock = false;
    ...
    public Introspection getIntrospectionData() {
        ...
        if ((state_0 & 0b10000) != 0 /* is-state_0 doIntDouble(Frame) */) {
            s[1] = (byte)0b01 /* active */;
        } else if ((exclude & 0b1000) != 0 /* is-exclude doIntDouble(Frame) */) {
            s[1] = (byte)0b10 /* excluded */;
        } else {
            s[1] = (byte)0b00 /* inactive */;
        }
    ...
    public static LocalVarPostfixIncNode create(LocalVarOp op, FrameSlot frameSlot, boolean hasTemporalDeadZone, ScopeFrameNode scopeFrameNode, FrameDescriptor frameDescriptor) {
        return new LocalVarPostfixIncNodeGen(op, frameSlot, hasTemporalDeadZone, scopeFrameNode, frameDescriptor);
    }
