...
public final class JSBitwiseAndNodeGen extends JSBitwiseAndNode implements Introspection.Provider {
    ...
    public Object executeObject(Object leftNodeValue, Object rightNodeValue) {
        ...
        if ((state_0 & 0b11000000) != 0 /* is-state_0 doOverloaded(Object, Object, JSOverloadedBinaryNode) || doGeneric(Object, Object, JSToNumericNode, JSToNumericNode, JSBitwiseAndNode, BranchProfile) */) {
            ...
            if ((state_0 & 0b10000000) != 0 /* is-state_0 doGeneric(Object, Object, JSToNumericNode, JSToNumericNode, JSBitwiseAndNode, BranchProfile) */) {
    ...
    private Object executeAndSpecialize(Object leftNodeValue, Object rightNodeValue) {
        ...
        try {
            ...
            if ((!(JSGuards.hasOverloadedOperators(leftNodeValue))) && (!(JSGuards.hasOverloadedOperators(rightNodeValue)))) {
                ...
                this.state_0_ = state_0 = state_0 | 0b10000000 /* add-state_0 doGeneric(Object, Object, JSToNumericNode, JSToNumericNode, JSBitwiseAndNode, BranchProfile) */;
                lock.unlock();
                hasLock = false;
                return doGeneric(leftNodeValue, rightNodeValue, s7_.leftNumeric_, s7_.rightNumeric_, s7_.and_, s7_.mixedNumericTypes_);
            }
