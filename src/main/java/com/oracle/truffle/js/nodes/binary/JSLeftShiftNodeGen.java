...
public final class JSLeftShiftNodeGen extends JSLeftShiftNode implements Introspection.Provider {
    ...
    public Object executeObject(Object leftNodeValue, Object rightNodeValue) {
        ...
        if ((state_0 & 0b11) != 0 /* is-state_0 doInteger(int, int) || doIntegerDouble(int, double) */ && leftNodeValue instanceof Integer) {
            int leftNodeValue_ = (int) leftNodeValue;
            if ((state_0 & 0b1) != 0 /* is-state_0 doInteger(int, int) */ && rightNodeValue instanceof Integer) {
                int rightNodeValue_ = (int) rightNodeValue;
                return doInteger(leftNodeValue_, rightNodeValue_);
            }
            if ((state_0 & 0b10) != 0 /* is-state_0 doIntegerDouble(int, double) */ && JSTypesGen.isImplicitDouble((state_0 & 0b1111000000) >>> 6 /* extract-implicit-state_0 1:double */, rightNodeValue)) {
        ...
        if ((state_0 & 0b100) != 0 /* is-state_0 doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) */ && JSTypesGen.isImplicitDouble((state_0 & 0b11110000000000) >>> 10 /* extract-implicit-state_0 0:double */, leftNodeValue)) {
            ...
            if (JSTypesGen.isImplicitDouble((state_0 & 0b1111000000) >>> 6 /* extract-implicit-state_0 1:double */, rightNodeValue)) {
                double rightNodeValue_ = JSTypesGen.asImplicitDouble((state_0 & 0b1111000000) >>> 6 /* extract-implicit-state_0 1:double */, rightNodeValue);
                DoubleData s2_ = this.double_cache;
                if (s2_ != null) {
                    return doDouble(leftNodeValue_, rightNodeValue_, s2_.leftShift_, s2_.leftInt32_, s2_.rightUInt32_);
                }
            }
        }
        ...
        if ((state_0 & 0b110000) != 0 /* is-state_0 doOverloaded(Object, Object, JSOverloadedBinaryNode) || doGeneric(Object, Object, JSLeftShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */) {
            ...
            if ((state_0 & 0b100000) != 0 /* is-state_0 doGeneric(Object, Object, JSLeftShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */) {
    ...
    public Object execute(VirtualFrame frameValue) {
        int state_0 = this.state_0_;
        if ((state_0 & 0b111110) == 0 /* only-active doInteger(int, int) */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int, int) && doIntegerDouble(int, double) && doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) && doBigInt(BigInt, BigInt) && doOverloaded(Object, Object, JSOverloadedBinaryNode) && doGeneric(Object, Object, JSLeftShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */)) {
            return execute_int_int0(state_0, frameValue);
        } else if ((state_0 & 0b111101) == 0 /* only-active doIntegerDouble(int, double) */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int, int) && doIntegerDouble(int, double) && doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) && doBigInt(BigInt, BigInt) && doOverloaded(Object, Object, JSOverloadedBinaryNode) && doGeneric(Object, Object, JSLeftShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */)) {
            return execute_int_double1(state_0, frameValue);
        } else if ((state_0 & 0b111011) == 0 /* only-active doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int, int) && doIntegerDouble(int, double) && doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) && doBigInt(BigInt, BigInt) && doOverloaded(Object, Object, JSOverloadedBinaryNode) && doGeneric(Object, Object, JSLeftShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */)) {
    ...
    private Object execute_int_double1(int state_0, VirtualFrame frameValue) {
        ...
        try {
            if ((state_0 & 0b1110000000) == 0 /* only-active 1:double */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int, int) && doIntegerDouble(int, double) && doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) && doBigInt(BigInt, BigInt) && doOverloaded(Object, Object, JSOverloadedBinaryNode) && doGeneric(Object, Object, JSLeftShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */)) {
                rightNodeValue_long = super.rightNode.executeLong(frameValue);
                rightNodeValue_ = JSTypes.longToDouble(rightNodeValue_long);
            } else if ((state_0 & 0b1101000000) == 0 /* only-active 1:double */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int, int) && doIntegerDouble(int, double) && doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) && doBigInt(BigInt, BigInt) && doOverloaded(Object, Object, JSOverloadedBinaryNode) && doGeneric(Object, Object, JSLeftShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */)) {
                rightNodeValue_int = super.rightNode.executeInt(frameValue);
                rightNodeValue_ = JSTypes.intToDouble(rightNodeValue_int);
            } else if ((state_0 & 0b1011000000) == 0 /* only-active 1:double */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int, int) && doIntegerDouble(int, double) && doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) && doBigInt(BigInt, BigInt) && doOverloaded(Object, Object, JSOverloadedBinaryNode) && doGeneric(Object, Object, JSLeftShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */)) {
        ...
        assert (state_0 & 0b10) != 0 /* is-state_0 doIntegerDouble(int, double) */;
        if ((!(JSBinaryNode.largerThan2e32(rightNodeValue_)))) {
            return doIntegerDouble(leftNodeValue_, rightNodeValue_);
        }
        CompilerDirectives.transferToInterpreterAndInvalidate();
        return executeAndSpecialize(leftNodeValue_, ((state_0 & 0b1110000000) == 0 /* only-active 1:double */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int, int) && doIntegerDouble(int, double) && doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) && doBigInt(BigInt, BigInt) && doOverloaded(Object, Object, JSOverloadedBinaryNode) && doGeneric(Object, Object, JSLeftShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */) ? (Object) rightNodeValue_long : ((state_0 & 0b1101000000) == 0 /* only-active 1:double */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int, int) && doIntegerDouble(int, double) && doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) && doBigInt(BigInt, BigInt) && doOverloaded(Object, Object, JSOverloadedBinaryNode) && doGeneric(Object, Object, JSLeftShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */) ? (Object) rightNodeValue_int : (Object) rightNodeValue_)));
    }
    ...
    private Object execute_double_double2(int state_0, VirtualFrame frameValue) {
        ...
        try {
            if ((state_0 & 0b11100000000000) == 0 /* only-active 0:double */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int, int) && doIntegerDouble(int, double) && doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) && doBigInt(BigInt, BigInt) && doOverloaded(Object, Object, JSOverloadedBinaryNode) && doGeneric(Object, Object, JSLeftShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */)) {
                leftNodeValue_long = super.leftNode.executeLong(frameValue);
                leftNodeValue_ = JSTypes.longToDouble(leftNodeValue_long);
            } else if ((state_0 & 0b11010000000000) == 0 /* only-active 0:double */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int, int) && doIntegerDouble(int, double) && doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) && doBigInt(BigInt, BigInt) && doOverloaded(Object, Object, JSOverloadedBinaryNode) && doGeneric(Object, Object, JSLeftShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */)) {
                leftNodeValue_int = super.leftNode.executeInt(frameValue);
                leftNodeValue_ = JSTypes.intToDouble(leftNodeValue_int);
            } else if ((state_0 & 0b10110000000000) == 0 /* only-active 0:double */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int, int) && doIntegerDouble(int, double) && doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) && doBigInt(BigInt, BigInt) && doOverloaded(Object, Object, JSOverloadedBinaryNode) && doGeneric(Object, Object, JSLeftShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */)) {
        ...
        try {
            ...
            return executeAndSpecialize(((state_0 & 0b11100000000000) == 0 /* only-active 0:double */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int, int) && doIntegerDouble(int, double) && doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) && doBigInt(BigInt, BigInt) && doOverloaded(Object, Object, JSOverloadedBinaryNode) && doGeneric(Object, Object, JSLeftShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */) ? (Object) leftNodeValue_long : ((state_0 & 0b11010000000000) == 0 /* only-active 0:double */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int, int) && doIntegerDouble(int, double) && doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) && doBigInt(BigInt, BigInt) && doOverloaded(Object, Object, JSOverloadedBinaryNode) && doGeneric(Object, Object, JSLeftShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */) ? (Object) leftNodeValue_int : (Object) leftNodeValue_)), ex.getResult());
        }
        assert (state_0 & 0b100) != 0 /* is-state_0 doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) */;
        DoubleData s2_ = this.double_cache;
        if (s2_ != null) {
            return doDouble(leftNodeValue_, rightNodeValue_, s2_.leftShift_, s2_.leftInt32_, s2_.rightUInt32_);
        }
        CompilerDirectives.transferToInterpreterAndInvalidate();
        return executeAndSpecialize(((state_0 & 0b11100000000000) == 0 /* only-active 0:double */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int, int) && doIntegerDouble(int, double) && doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) && doBigInt(BigInt, BigInt) && doOverloaded(Object, Object, JSOverloadedBinaryNode) && doGeneric(Object, Object, JSLeftShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */) ? (Object) leftNodeValue_long : ((state_0 & 0b11010000000000) == 0 /* only-active 0:double */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int, int) && doIntegerDouble(int, double) && doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) && doBigInt(BigInt, BigInt) && doOverloaded(Object, Object, JSOverloadedBinaryNode) && doGeneric(Object, Object, JSLeftShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */) ? (Object) leftNodeValue_int : (Object) leftNodeValue_)), ((state_0 & 0b1110000000) == 0 /* only-active 1:double */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int, int) && doIntegerDouble(int, double) && doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) && doBigInt(BigInt, BigInt) && doOverloaded(Object, Object, JSOverloadedBinaryNode) && doGeneric(Object, Object, JSLeftShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */) ? (Object) rightNodeValue_long : ((state_0 & 0b1101000000) == 0 /* only-active 1:double */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int, int) && doIntegerDouble(int, double) && doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) && doBigInt(BigInt, BigInt) && doOverloaded(Object, Object, JSOverloadedBinaryNode) && doGeneric(Object, Object, JSLeftShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */) ? (Object) rightNodeValue_int : (Object) rightNodeValue_)));
    }
    ...
    private Object execute_generic3(int state_0, VirtualFrame frameValue) {
        ...
        if ((state_0 & 0b11) != 0 /* is-state_0 doInteger(int, int) || doIntegerDouble(int, double) */ && leftNodeValue_ instanceof Integer) {
            ...
            if ((state_0 & 0b10) != 0 /* is-state_0 doIntegerDouble(int, double) */ && JSTypesGen.isImplicitDouble((state_0 & 0b1111000000) >>> 6 /* extract-implicit-state_0 1:double */, rightNodeValue_)) {
        ...
        if ((state_0 & 0b100) != 0 /* is-state_0 doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) */ && JSTypesGen.isImplicitDouble((state_0 & 0b11110000000000) >>> 10 /* extract-implicit-state_0 0:double */, leftNodeValue_)) {
            ...
            if (JSTypesGen.isImplicitDouble((state_0 & 0b1111000000) >>> 6 /* extract-implicit-state_0 1:double */, rightNodeValue_)) {
                double rightNodeValue__ = JSTypesGen.asImplicitDouble((state_0 & 0b1111000000) >>> 6 /* extract-implicit-state_0 1:double */, rightNodeValue_);
                DoubleData s2_ = this.double_cache;
                if (s2_ != null) {
                    return doDouble(leftNodeValue__, rightNodeValue__, s2_.leftShift_, s2_.leftInt32_, s2_.rightUInt32_);
                }
            }
        }
    ...
    public int executeInt(VirtualFrame frameValue) throws UnexpectedResultException {
        int state_0 = this.state_0_;
        if ((state_0 & 0b110100) != 0 /* is-state_0 doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) || doOverloaded(Object, Object, JSOverloadedBinaryNode) || doGeneric(Object, Object, JSLeftShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */) {
        ...
        if ((state_0 & 0b10) == 0 /* only-active doInteger(int, int) */ && ((state_0 & 0b11) != 0  /* is-not doInteger(int, int) && doIntegerDouble(int, double) */)) {
            return executeInt_int4(state_0, frameValue, leftNodeValue_);
        } else if ((state_0 & 0b1) == 0 /* only-active doIntegerDouble(int, double) */ && ((state_0 & 0b11) != 0  /* is-not doInteger(int, int) && doIntegerDouble(int, double) */)) {
    ...
    private int executeInt_double5(int state_0, VirtualFrame frameValue, int leftNodeValue_) throws UnexpectedResultException {
        ...
        CompilerDirectives.transferToInterpreterAndInvalidate();
        return JSTypesGen.expectInteger(executeAndSpecialize(leftNodeValue_, ((state_0 & 0b1110000000) == 0 /* only-active 1:double */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int, int) && doIntegerDouble(int, double) && doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) && doBigInt(BigInt, BigInt) && doOverloaded(Object, Object, JSOverloadedBinaryNode) && doGeneric(Object, Object, JSLeftShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */) ? (Object) rightNodeValue_long : ((state_0 & 0b1101000000) == 0 /* only-active 1:double */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int, int) && doIntegerDouble(int, double) && doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) && doBigInt(BigInt, BigInt) && doOverloaded(Object, Object, JSOverloadedBinaryNode) && doGeneric(Object, Object, JSLeftShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */) ? (Object) rightNodeValue_int : (Object) rightNodeValue_))));
    }
    ...
    public void executeVoid(VirtualFrame frameValue) {
        int state_0 = this.state_0_;
        try {
            if ((state_0 & 0b111100) == 0 /* only-active doInteger(int, int) && doIntegerDouble(int, double) */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int, int) && doIntegerDouble(int, double) && doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) && doBigInt(BigInt, BigInt) && doOverloaded(Object, Object, JSOverloadedBinaryNode) && doGeneric(Object, Object, JSLeftShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */)) {
    ...
    private Object executeAndSpecialize(Object leftNodeValue, Object rightNodeValue) {
        ...
        try {
            ...
            if (leftNodeValue instanceof Integer) {
                int leftNodeValue_ = (int) leftNodeValue;
                if (((exclude & 0b1)) == 0 /* is-not-exclude doInteger(int, int) */ && rightNodeValue instanceof Integer) {
                    int rightNodeValue_ = (int) rightNodeValue;
                ...
                if (((exclude & 0b10)) == 0 /* is-not-exclude doIntegerDouble(int, double) */) {
                    int doubleCast1;
                    if ((doubleCast1 = JSTypesGen.specializeImplicitDouble(rightNodeValue)) != 0) {
                        ...
                        if ((!(JSBinaryNode.largerThan2e32(rightNodeValue_)))) {
                            ...
                            this.state_0_ = state_0 = state_0 | 0b10 /* add-state_0 doIntegerDouble(int, double) */;
                            lock.unlock();
                            hasLock = false;
                            return doIntegerDouble(leftNodeValue_, rightNodeValue_);
                        }
            ...
            if (((exclude & 0b100)) == 0 /* is-not-exclude doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) */) {
                int doubleCast0;
                if ((doubleCast0 = JSTypesGen.specializeImplicitDouble(leftNodeValue)) != 0) {
                    ...
                    if ((doubleCast1 = JSTypesGen.specializeImplicitDouble(rightNodeValue)) != 0) {
                        ...
                        state_0 = (state_0 | (doubleCast1 << 6) /* set-implicit-state_0 1:double */);
                        this.state_0_ = state_0 = state_0 | 0b100 /* add-state_0 doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) */;
                        lock.unlock();
                        hasLock = false;
                        return doDouble(leftNodeValue_, rightNodeValue_, s2_.leftShift_, s2_.leftInt32_, s2_.rightUInt32_);
                    }
            ...
            if (((exclude & 0b1000)) == 0 /* is-not-exclude doBigInt(BigInt, BigInt) */ && leftNodeValue instanceof BigInt) {
                BigInt leftNodeValue_ = (BigInt) leftNodeValue;
                if (rightNodeValue instanceof BigInt) {
                    BigInt rightNodeValue_ = (BigInt) rightNodeValue;
            ...
            if ((!(JSGuards.hasOverloadedOperators(leftNodeValue))) && (!(JSGuards.hasOverloadedOperators(rightNodeValue)))) {
                ...
                this.exclude_ = exclude = exclude | 0b1111 /* add-exclude doInteger(int, int), doIntegerDouble(int, double), doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node), doBigInt(BigInt, BigInt) */;
                this.double_cache = null;
                state_0 = state_0 & 0xfffffff0 /* remove-state_0 doInteger(int, int), doIntegerDouble(int, double), doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node), doBigInt(BigInt, BigInt) */;
                this.state_0_ = state_0 = state_0 | 0b100000 /* add-state_0 doGeneric(Object, Object, JSLeftShiftNode, JSToNumericNode, JSToNumericNode, BranchProfile) */;
                lock.unlock();
                hasLock = false;
                return doGeneric(leftNodeValue, rightNodeValue, s5_.leftShift_, s5_.leftToNumeric_, s5_.rightToNumeric_, s5_.mixedNumericTypes_);
            }
    ...
    public Introspection getIntrospectionData() {
        ...
        s = new Object[3];
        s[0] = "doIntegerDouble";
        if ((state_0 & 0b10) != 0 /* is-state_0 doIntegerDouble(int, double) */) {
            s[1] = (byte)0b01 /* active */;
        } else if ((exclude & 0b10) != 0 /* is-exclude doIntegerDouble(int, double) */) {
            s[1] = (byte)0b10 /* excluded */;
        } else {
            s[1] = (byte)0b00 /* inactive */;
        }
        ...
        s = new Object[3];
        s[0] = "doDouble";
        if ((state_0 & 0b100) != 0 /* is-state_0 doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) */) {
            s[1] = (byte)0b01 /* active */;
            ...
            s[2] = cached;
        } else if ((exclude & 0b100) != 0 /* is-exclude doDouble(double, double, JSLeftShiftNode, JSToInt32Node, JSToUInt32Node) */) {
            s[1] = (byte)0b10 /* excluded */;
        } else {
            s[1] = (byte)0b00 /* inactive */;
        }
        ...
        if ((state_0 & 0b1000) != 0 /* is-state_0 doBigInt(BigInt, BigInt) */) {
            s[1] = (byte)0b01 /* active */;
        } else if ((exclude & 0b1000) != 0 /* is-exclude doBigInt(BigInt, BigInt) */) {
            s[1] = (byte)0b10 /* excluded */;
        } else {
            s[1] = (byte)0b00 /* inactive */;
        }
