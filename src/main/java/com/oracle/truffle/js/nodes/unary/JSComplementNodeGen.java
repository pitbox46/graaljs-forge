...
public final class JSComplementNodeGen extends JSComplementNode implements Introspection.Provider {
    ...
    public Object execute(VirtualFrame frameValue, Object operandNodeValue) {
        ...
        if ((state_0 & 0b100000) != 0 /* is-state_0 doGeneric(VirtualFrame, Object, JSToNumericNode, JSComplementNode) */) {
    ...
    public Object execute(VirtualFrame frameValue) {
        int state_0 = this.state_0_;
        if ((state_0 & 0b111110) == 0 /* only-active doInteger(int) */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) && doBigInt(BigInt) && doOverloaded(JSOverloadedOperatorsObject, JSOverloadedUnaryNode) && doGeneric(VirtualFrame, Object, JSToNumericNode, JSComplementNode) */)) {
            return execute_int0(state_0, frameValue);
        } else if ((state_0 & 0b111011) == 0 /* only-active doDouble(double, JSToInt32Node) */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) && doBigInt(BigInt) && doOverloaded(JSOverloadedOperatorsObject, JSOverloadedUnaryNode) && doGeneric(VirtualFrame, Object, JSToNumericNode, JSComplementNode) */)) {
    ...
    private Object execute_double1(int state_0, VirtualFrame frameValue) {
        ...
        try {
            if ((state_0 & 0b1110000000) == 0 /* only-active 0:double */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) && doBigInt(BigInt) && doOverloaded(JSOverloadedOperatorsObject, JSOverloadedUnaryNode) && doGeneric(VirtualFrame, Object, JSToNumericNode, JSComplementNode) */)) {
            ...
            } else if ((state_0 & 0b1101000000) == 0 /* only-active 0:double */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) && doBigInt(BigInt) && doOverloaded(JSOverloadedOperatorsObject, JSOverloadedUnaryNode) && doGeneric(VirtualFrame, Object, JSToNumericNode, JSComplementNode) */)) {
                operandNodeValue_int = super.operandNode.executeInt(frameValue);
                operandNodeValue_ = JSTypes.intToDouble(operandNodeValue_int);
            } else if ((state_0 & 0b1011000000) == 0 /* only-active 0:double */ && ((state_0 & 0b111111) != 0  /* is-not doInteger(int) && doSafeInteger(SafeInteger) && doDouble(double, JSToInt32Node) && doBigInt(BigInt) && doOverloaded(JSOverloadedOperatorsObject, JSOverloadedUnaryNode) && doGeneric(VirtualFrame, Object, JSToNumericNode, JSComplementNode) */)) {
    ...
    public int executeInt(VirtualFrame frameValue) throws UnexpectedResultException {
        int state_0 = this.state_0_;
        if ((state_0 & 0b110000) != 0 /* is-state_0 doOverloaded(JSOverloadedOperatorsObject, JSOverloadedUnaryNode) || doGeneric(VirtualFrame, Object, JSToNumericNode, JSComplementNode) */) {
    ...
    private Object executeAndSpecialize(VirtualFrame frameValue, Object operandNodeValue) {
        ...
        try {
            ...
            if ((!(JSGuards.hasOverloadedOperators(operandNodeValue)))) {
                ...
                this.state_0_ = state_0 = state_0 | 0b100000 /* add-state_0 doGeneric(VirtualFrame, Object, JSToNumericNode, JSComplementNode) */;
                lock.unlock();
                hasLock = false;
                return doGeneric(frameValue, operandNodeValue, this.generic_toNumericNode_, this.generic_recursive_);
            }
