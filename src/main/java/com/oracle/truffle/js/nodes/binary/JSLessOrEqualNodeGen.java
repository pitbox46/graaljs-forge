...
public final class JSLessOrEqualNodeGen extends JSLessOrEqualNode implements Introspection.Provider {
    ...
    public boolean executeBoolean(Object leftNodeValue, Object rightNodeValue) {
        ...
        if ((state_0 & 0x38000) != 0 /* is-state_0 doJavaNumber(Object, Object) || doOverloaded(Object, Object, JSOverloadedBinaryNode, JSToBooleanNode) || doGeneric(Object, Object, JSToStringOrNumberNode, JSToPrimitiveNode, JSToStringOrNumberNode, JSToPrimitiveNode, JSLessOrEqualNode) */) {
            ...
            if ((state_0 & 0x20000) != 0 /* is-state_0 doGeneric(Object, Object, JSToStringOrNumberNode, JSToPrimitiveNode, JSToStringOrNumberNode, JSToPrimitiveNode, JSLessOrEqualNode) */) {
    ...
    private boolean executeAndSpecialize(Object leftNodeValue, Object rightNodeValue) {
        ...
        try {
            ...
            if ((!(JSGuards.hasOverloadedOperators(leftNodeValue))) && (!(JSGuards.hasOverloadedOperators(rightNodeValue)))) {
                ...
                this.state_0_ = state_0 = state_0 | 0x20000 /* add-state_0 doGeneric(Object, Object, JSToStringOrNumberNode, JSToPrimitiveNode, JSToStringOrNumberNode, JSToPrimitiveNode, JSLessOrEqualNode) */;
                lock.unlock();
                hasLock = false;
                return doGeneric(leftNodeValue, rightNodeValue, s17_.toStringOrNumber1_, s17_.toPrimitive1_, s17_.toStringOrNumber2_, s17_.toPrimitive2_, s17_.lessOrEqualNode_);
            }
