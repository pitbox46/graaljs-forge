...
public final class MapIteratorPrototypeBuiltinsFactory {
    ...
    public static final class MapIteratorNextNodeGen extends MapIteratorNextNode implements Introspection.Provider {
        ...
        public Object execute(VirtualFrame frameValue) {
            ...
            if ((state_0 & 0b1) != 0 /* is-state_0 doMapIterator(VirtualFrame, DynamicObject) */ && JSTypes.isDynamicObject(arguments0Value_)) {
        ...
        private DynamicObject executeAndSpecialize(VirtualFrame frameValue, Object arguments0Value) {
            ...
            if (JSTypes.isDynamicObject(arguments0Value)) {
                DynamicObject arguments0Value_ = (DynamicObject) arguments0Value;
                if ((isMapIterator(arguments0Value_))) {
                    this.state_0_ = state_0 = state_0 | 0b1 /* add-state_0 doMapIterator(VirtualFrame, DynamicObject) */;
        ...
        public Introspection getIntrospectionData() {
            ...
            s = new Object[3];
            s[0] = "doMapIterator";
            if ((state_0 & 0b1) != 0 /* is-state_0 doMapIterator(VirtualFrame, DynamicObject) */) {
