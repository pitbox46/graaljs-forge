...
public final class ExpNodeGen extends ExpNode implements Introspection.Provider {
    ...
    public Object execute(VirtualFrame frameValue) {
        ...
        if ((state_0 & 0b10) == 0 /* only-active exp(double) */ && ((state_0 & 0b11) != 0  /* is-not exp(double) && exp(Object) */)) {
    ...
    private Object execute_double0(int state_0, VirtualFrame frameValue) {
        ...
        try {
            if ((state_0 & 0b111000) == 0 /* only-active 0:double */ && ((state_0 & 0b11) != 0  /* is-not exp(double) && exp(Object) */)) {
                arguments0Value_long = this.arguments0_.executeLong(frameValue);
                arguments0Value_ = JSTypes.longToDouble(arguments0Value_long);
            } else if ((state_0 & 0b110100) == 0 /* only-active 0:double */ && ((state_0 & 0b11) != 0  /* is-not exp(double) && exp(Object) */)) {
                arguments0Value_int = this.arguments0_.executeInt(frameValue);
                arguments0Value_ = JSTypes.intToDouble(arguments0Value_int);
            } else if ((state_0 & 0b101100) == 0 /* only-active 0:double */ && ((state_0 & 0b11) != 0  /* is-not exp(double) && exp(Object) */)) {
        ...
        assert (state_0 & 0b1) != 0 /* is-state_0 exp(double) */;
        return ExpNode.exp(arguments0Value_);
    }

    private Object execute_generic1(int state_0, VirtualFrame frameValue) {
        Object arguments0Value_ = this.arguments0_.execute(frameValue);
        if ((state_0 & 0b1) != 0 /* is-state_0 exp(double) */ && JSTypesGen.isImplicitDouble((state_0 & 0b111100) >>> 2 /* extract-implicit-state_0 0:double */, arguments0Value_)) {
        ...
        if ((state_0 & 0b10) != 0 /* is-state_0 exp(Object) */) {
    ...
    private double executeAndSpecialize(Object arguments0Value) {
        int state_0 = this.state_0_;
        {
            ...
            if ((doubleCast0 = JSTypesGen.specializeImplicitDouble(arguments0Value)) != 0) {
                ...
                this.state_0_ = state_0 = state_0 | 0b1 /* add-state_0 exp(double) */;
                return ExpNode.exp(arguments0Value_);
            }
        }
        this.state_0_ = state_0 = state_0 | 0b10 /* add-state_0 exp(Object) */;
    ...
    public Introspection getIntrospectionData() {
        ...
        s = new Object[3];
        s[0] = "exp";
        if ((state_0 & 0b1) != 0 /* is-state_0 exp(double) */) {
