...
public final class PluralRulesPrototypeBuiltinsFactory {
    ...
    public static final class JSPluralRulesResolvedOptionsNodeGen extends JSPluralRulesResolvedOptionsNode implements Introspection.Provider {
    ...
    public static final class JSPluralRulesSelectNodeGen extends JSPluralRulesSelectNode implements Introspection.Provider {
        ...
        public Object execute(VirtualFrame frameValue) {
            ...
            if ((state_0 & 0b1) != 0 /* is-state_0 doSelect(DynamicObject, Object) */ && JSTypes.isDynamicObject(arguments0Value_)) {
                DynamicObject arguments0Value__ = (DynamicObject) arguments0Value_;
                if ((JSGuards.isJSPluralRules(arguments0Value__))) {
        ...
        public void executeVoid(VirtualFrame frameValue) {
            int state_0 = this.state_0_;
            if ((state_0 & 0b1) != 0 /* is-state_0 doSelect(DynamicObject, Object) */) {
                execute(frameValue);
                return;
            }
            Object arguments0Value_ = this.arguments0_.execute(frameValue);
        ...
        private Object executeAndSpecialize(Object arguments0Value, Object arguments1Value) {
            ...
            if (JSTypes.isDynamicObject(arguments0Value)) {
                DynamicObject arguments0Value_ = (DynamicObject) arguments0Value;
                if ((JSGuards.isJSPluralRules(arguments0Value_))) {
                    this.state_0_ = state_0 = state_0 | 0b1 /* add-state_0 doSelect(DynamicObject, Object) */;
