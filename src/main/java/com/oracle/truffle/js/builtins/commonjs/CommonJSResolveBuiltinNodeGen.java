...
public final class CommonJSResolveBuiltinNodeGen extends CommonJSResolveBuiltin implements Introspection.Provider {
    ...
    public Object execute(VirtualFrame frameValue) {
        ...
        if ((state_0 & 0b1) != 0 /* is-state_0 resolve(String) */ && JSTypesGen.isImplicitString((state_0 & 0b1110) >>> 1 /* extract-implicit-state_0 0:String */, arguments0Value_)) {
            String arguments0Value__ = JSTypesGen.asImplicitString((state_0 & 0b1110) >>> 1 /* extract-implicit-state_0 0:String */, arguments0Value_);
    ...
    private String executeAndSpecialize(Object arguments0Value) {
        int state_0 = this.state_0_;
        {
            ...
            if ((stringCast0 = JSTypesGen.specializeImplicitString(arguments0Value)) != 0) {
                ...
                state_0 = (state_0 | (stringCast0 << 1) /* set-implicit-state_0 0:String */);
                this.state_0_ = state_0 = state_0 | 0b1 /* add-state_0 resolve(String) */;
    ...
    public Introspection getIntrospectionData() {
        ...
        s = new Object[3];
        s[0] = "resolve";
        if ((state_0 & 0b1) != 0 /* is-state_0 resolve(String) */) {
