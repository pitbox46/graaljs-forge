...
public final class FroundNodeGen extends FroundNode implements Introspection.Provider {
    ...
    public Object execute(VirtualFrame frameValue) {
        ...
        if ((state_0 & 0b110) == 0 /* only-active fround(int) */ && ((state_0 & 0b111) != 0  /* is-not fround(int) && fround(double) && fround(Object) */)) {
            return execute_int0(state_0, frameValue);
        } else if ((state_0 & 0b101) == 0 /* only-active fround(double) */ && ((state_0 & 0b111) != 0  /* is-not fround(int) && fround(double) && fround(Object) */)) {
    ...
    private Object execute_int0(int state_0, VirtualFrame frameValue) {
        ...
        assert (state_0 & 0b1) != 0 /* is-state_0 fround(int) */;
    ...
    private Object execute_double1(int state_0, VirtualFrame frameValue) {
        ...
        try {
            if ((state_0 & 0b1110000) == 0 /* only-active 0:double */ && ((state_0 & 0b111) != 0  /* is-not fround(int) && fround(double) && fround(Object) */)) {
                arguments0Value_long = this.arguments0_.executeLong(frameValue);
                arguments0Value_ = JSTypes.longToDouble(arguments0Value_long);
            } else if ((state_0 & 0b1101000) == 0 /* only-active 0:double */ && ((state_0 & 0b111) != 0  /* is-not fround(int) && fround(double) && fround(Object) */)) {
                arguments0Value_int = this.arguments0_.executeInt(frameValue);
                arguments0Value_ = JSTypes.intToDouble(arguments0Value_int);
            } else if ((state_0 & 0b1011000) == 0 /* only-active 0:double */ && ((state_0 & 0b111) != 0  /* is-not fround(int) && fround(double) && fround(Object) */)) {
        ...
        assert (state_0 & 0b10) != 0 /* is-state_0 fround(double) */;
        return FroundNode.fround(arguments0Value_);
    }

    private Object execute_generic2(int state_0, VirtualFrame frameValue) {
        Object arguments0Value_ = this.arguments0_.execute(frameValue);
        if ((state_0 & 0b1) != 0 /* is-state_0 fround(int) */ && arguments0Value_ instanceof Integer) {
        ...
        if ((state_0 & 0b10) != 0 /* is-state_0 fround(double) */ && JSTypesGen.isImplicitDouble((state_0 & 0b1111000) >>> 3 /* extract-implicit-state_0 0:double */, arguments0Value_)) {
        ...
        if ((state_0 & 0b100) != 0 /* is-state_0 fround(Object) */) {
    ...
    public double executeDouble(VirtualFrame frameValue) throws UnexpectedResultException {
        int state_0 = this.state_0_;
        if ((state_0 & 0b100) == 0 /* only-active fround(double) */ && ((state_0 & 0b110) != 0  /* is-not fround(double) && fround(Object) */)) {
    ...
    public int executeInt(VirtualFrame frameValue) throws UnexpectedResultException {
        ...
        if ((state_0 & 0b1) != 0 /* is-state_0 fround(int) */) {
            if ((JSRuntime.intIsRepresentableAsFloat(arguments0Value_))) {
                return FroundNode.fround(arguments0Value_);
            }
        }
    ...
    public void executeVoid(VirtualFrame frameValue) {
        ...
        try {
            if ((state_0 & 0b110) == 0 /* only-active fround(int) */ && ((state_0 & 0b111) != 0  /* is-not fround(int) && fround(double) && fround(Object) */)) {
                ...
                return;
            } else if ((state_0 & 0b1) == 0 /* only-active fround(double) && fround(Object) */ && ((state_0 & 0b111) != 0  /* is-not fround(int) && fround(double) && fround(Object) */)) {
    ...
    private Object executeAndSpecialize(Object arguments0Value) {
        ...
        if (arguments0Value instanceof Integer) {
            ...
            if ((JSRuntime.intIsRepresentableAsFloat(arguments0Value_))) {
                this.state_0_ = state_0 = state_0 | 0b1 /* add-state_0 fround(int) */;
                return FroundNode.fround(arguments0Value_);
            }
        }
        {
            ...
            if ((doubleCast0 = JSTypesGen.specializeImplicitDouble(arguments0Value)) != 0) {
                ...
                this.state_0_ = state_0 = state_0 | 0b10 /* add-state_0 fround(double) */;
                return FroundNode.fround(arguments0Value_);
            }
        }
        this.state_0_ = state_0 = state_0 | 0b100 /* add-state_0 fround(Object) */;
    ...
    public Introspection getIntrospectionData() {
        ...
        s = new Object[3];
        s[0] = "fround";
        if ((state_0 & 0b10) != 0 /* is-state_0 fround(double) */) {
            s[1] = (byte)0b01 /* active */;
        } else {
            s[1] = (byte)0b00 /* inactive */;
        }
