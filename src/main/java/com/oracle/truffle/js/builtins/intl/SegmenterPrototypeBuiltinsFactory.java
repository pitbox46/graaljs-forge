...
public final class SegmenterPrototypeBuiltinsFactory {
    ...
    public static final class JSSegmenterResolvedOptionsNodeGen extends JSSegmenterResolvedOptionsNode implements Introspection.Provider {
    ...
    public static final class JSSegmenterSegmentNodeGen extends JSSegmenterSegmentNode implements Introspection.Provider {

        @Child private JavaScriptNode arguments0_;
        @Child private JavaScriptNode arguments1_;
        @CompilationFinal private volatile int state_0_;
        @Child private JSToStringNode segmenter_toStringNode_;
        ...
        public Object execute(VirtualFrame frameValue) {
            ...
            if ((state_0 & 0b1) != 0 /* is-state_0 doSegmenter(JSSegmenterObject, Object, JSToStringNode) */ && arguments0Value_ instanceof JSSegmenterObject) {
                JSSegmenterObject arguments0Value__ = (JSSegmenterObject) arguments0Value_;
                return doSegmenter(arguments0Value__, arguments1Value_, this.segmenter_toStringNode_);
            }
            CompilerDirectives.transferToInterpreterAndInvalidate();
        ...
        public void executeVoid(VirtualFrame frameValue) {
            int state_0 = this.state_0_;
            if ((state_0 & 0b1) != 0 /* is-state_0 doSegmenter(JSSegmenterObject, Object, JSToStringNode) */) {
                execute(frameValue);
                return;
            }
            Object arguments0Value_ = this.arguments0_.execute(frameValue);
        ...
        private Object executeAndSpecialize(Object arguments0Value, Object arguments1Value) {
            ...
            try {
                ...
                if (arguments0Value instanceof JSSegmenterObject) {
                    ...
                    this.state_0_ = state_0 = state_0 | 0b1 /* add-state_0 doSegmenter(JSSegmenterObject, Object, JSToStringNode) */;
                    lock.unlock();
                    hasLock = false;
                    return doSegmenter(arguments0Value_, arguments1Value, this.segmenter_toStringNode_);
                }
                if ((!(JSGuards.isJSSegmenter(arguments0Value)))) {
