...
public final class TypedArrayFunctionBuiltinsFactory {
    ...
    public static final class TypedArrayOfNodeGen extends TypedArrayOfNode implements Introspection.Provider {
    ...
    public static final class TypedArrayFromNodeGen extends TypedArrayFromNode implements Introspection.Provider {
