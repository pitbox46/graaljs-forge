...
public final class WeakRefPrototypeBuiltinsFactory {
    ...
    public static final class JSWeakRefDerefNodeGen extends JSWeakRefDerefNode implements Introspection.Provider {
        ...
        public Object execute(VirtualFrame frameValue) {
            ...
            if ((state_0 & 0b1) != 0 /* is-state_0 deref(DynamicObject) */ && JSTypes.isDynamicObject(arguments0Value_)) {
                DynamicObject arguments0Value__ = (DynamicObject) arguments0Value_;
                if ((JSGuards.isJSWeakRef(arguments0Value__))) {
                    return deref(arguments0Value__);
                }
            }
            if ((state_0 & 0b10) != 0 /* is-state_0 notWeakRef(Object) */) {
        ...
        private DynamicObject executeAndSpecialize(Object arguments0Value) {
            ...
            if (JSTypes.isDynamicObject(arguments0Value)) {
                ...
                if ((JSGuards.isJSWeakRef(arguments0Value_))) {
                    this.state_0_ = state_0 = state_0 | 0b1 /* add-state_0 deref(DynamicObject) */;
                    return deref(arguments0Value_);
                }
            }
            if ((!(JSGuards.isJSWeakRef(arguments0Value)))) {
                this.state_0_ = state_0 = state_0 | 0b10 /* add-state_0 notWeakRef(Object) */;
        ...
        public Introspection getIntrospectionData() {
            ...
            s = new Object[3];
            s[0] = "deref";
            if ((state_0 & 0b1) != 0 /* is-state_0 deref(DynamicObject) */) {
