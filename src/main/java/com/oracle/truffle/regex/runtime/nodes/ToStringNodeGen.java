...
public final class ToStringNodeGen extends ToStringNode {
    ...
    public String execute(Object arg0Value) throws UnsupportedTypeException {
        ...
        if ((state_0 & 0b11110) != 0 /* is-state_0 doBoxedString(Object, InteropLibrary) || doBoxedString(Object, InteropLibrary) || doBoxedCharArray(Object, InteropLibrary, ToCharNode) || doBoxedCharArray(Object, InteropLibrary, ToCharNode) */) {
            ...
            if ((state_0 & 0b1000) != 0 /* is-state_0 doBoxedCharArray(Object, InteropLibrary, ToCharNode) */) {
            ...
            if ((state_0 & 0b10000) != 0 /* is-state_0 doBoxedCharArray(Object, InteropLibrary, ToCharNode) */) {
                EncapsulatingNodeReference encapsulating_ = EncapsulatingNodeReference.getCurrent();
                Node prev_ = encapsulating_.set(this);
                try {
                    {
    ...
    private String executeAndSpecialize(Object arg0Value) throws UnsupportedTypeException {
        ...
        try {
            ...
            if (((exclude & 0b10)) == 0 /* is-not-exclude doBoxedCharArray(Object, InteropLibrary, ToCharNode) */) {
                int count3_ = 0;
                BoxedCharArray0Data s3_ = this.boxedCharArray0_cache;
                if ((state_0 & 0b1000) != 0 /* is-state_0 doBoxedCharArray(Object, InteropLibrary, ToCharNode) */) {
                    while (s3_ != null) {
                ...
                if (s3_ == null) {
                    {
                        ...
                        if ((inputs__1.hasArrayElements(arg0Value)) && count3_ < (2)) {
                            ...
                            this.state_0_ = state_0 = state_0 | 0b1000 /* add-state_0 doBoxedCharArray(Object, InteropLibrary, ToCharNode) */;
                        }
                    }
                }
                if (s3_ != null) {
                    ...
                    try {
                        {
                            ...
                            if ((boxedCharArray1_inputs__.hasArrayElements(arg0Value))) {
                                ...
                                this.exclude_ = exclude = exclude | 0b10 /* add-exclude doBoxedCharArray(Object, InteropLibrary, ToCharNode) */;
                                this.boxedCharArray0_cache = null;
                                state_0 = state_0 & 0xfffffff7 /* remove-state_0 doBoxedCharArray(Object, InteropLibrary, ToCharNode) */;
                                this.state_0_ = state_0 = state_0 | 0b10000 /* add-state_0 doBoxedCharArray(Object, InteropLibrary, ToCharNode) */;
                                lock.unlock();
                                hasLock = false;
                                return ToStringNode.doBoxedCharArray(arg0Value, boxedCharArray1_inputs__, this.boxedCharArray1_toCharNode_);
                            }
