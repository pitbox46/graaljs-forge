...
class PolyglotMapEntry<K, V> implements Map.Entry<K, V>, PolyglotWrapper {
    ...
    static final class Cache {
        ...
        private static CallTarget initializeCall(PolyglotMapEntryNode node) {
        ...
        static Cache lookup(PolyglotLanguageContext languageContext, Class<?> receiverClass,
            ...
            if (cache == null) {
                cache = HostToGuestRootNode.installHostCodeCache(languageContext, cacheKey, new Cache(receiverClass, keyClass, keyType, valueClass, valueType),
                                Cache.class);
            }
        ...
        abstract static class GetNode extends PolyglotMapEntryNode {
