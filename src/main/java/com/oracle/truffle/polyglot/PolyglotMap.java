...
class PolyglotMap<K, V> extends AbstractMap<K, V> implements PolyglotWrapper {
    ...
    private final class LazyEntries extends AbstractEntrySet {
        ...
        private final class CombinedIterator implements Iterator<Entry<K, V>> {
            private final Iterator<Entry<K, V>> elemIter = new ElementsIterator();
            private final Iterator<Entry<K, V>> keysIter = new LazyKeysIterator();
            ...
            protected Object doCached(PolyglotLanguageContext languageContext, Object receiver, @SuppressWarnings("unused") Object[] args,
                ...
                if (interop.hasHashEntries(receiver)) {
                    try {
                        ...
                        genericType = new ParameterizedTypeImpl(Iterator.class, new ParameterizedTypeImpl(Entry.class, useKeyType, useValueType));
