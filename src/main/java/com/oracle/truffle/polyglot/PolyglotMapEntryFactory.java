...
import com.oracle.truffle.polyglot.PolyglotMapEntry.Cache;
import com.oracle.truffle.polyglot.PolyglotMapEntry.Cache.GetNode;
import com.oracle.truffle.polyglot.PolyglotMapEntry.Cache.PolyglotMapEntryNode;
...
final class PolyglotMapEntryFactory {
    ...
    static final class CacheFactory {
        ...
        static final class GetNodeGen extends GetNode {
            ...
            private GetNodeGen(Cache cache, String name, long index, Class<?> elementClass, Type elementType) {
                ...
                try {
                    ...
                    if ((exclude) == 0 /* is-not-exclude doCached(PolyglotLanguageContext, Object, Object[], InteropLibrary, PolyglotToHostNode, BranchProfile) */) {
                        ...
                        if (s0_ == null) {
                            ...
                            if (count0_ < (PolyglotMapEntryNode.LIMIT)) {
            ...
            public static GetNode create(Cache cache, String name, long index, Class<?> elementClass, Type elementType) {
